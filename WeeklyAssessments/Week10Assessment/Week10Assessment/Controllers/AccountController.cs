...
namespace Week10Assessment.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(Week10AssessmentContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,AccountNumber,Name,Balance")] Account account)
        {
